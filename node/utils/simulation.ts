export const getSimulationPayloadsByItem = (item: ItemWithSimulationInput, priceTable?: string, regionId?: string) => {
...
export const orderFormItemToSeller = (orderFormItem: OrderFormItem & { paymentData: any }) => {
  ...
  installmentOptions.forEach(
    (installmentOption: InstallmentOption) => installmentOption.installments.map(installment => {
