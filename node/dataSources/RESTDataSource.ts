...
export class RESTDataSource extends ApolloRESTDataSource<ServiceContext> {
  protected async get<TResult = any>(
    ...
    return this.withMetrics(
      () => super.get<TResult>(path, params, init),
      init && init.metric
    )
  }
  ...
  protected async post<TResult = any>(
    ...
    return this.withMetrics(
      () => super.post<TResult>(path, body, init),
      init && init.metric
    )
  }
  ...
  protected async patch<TResult = any>(
    ...
    return this.withMetrics(
      () => super.patch<TResult>(path, body, init),
      init && init.metric
    )
  }
  ...
  protected async put<TResult = any>(
    ...
    return this.withMetrics(
      () => super.put<TResult>(path, body, init),
      init && init.metric
    )
  }
  ...
  protected async delete<TResult = any>(
    ...
    return this.withMetrics(
      () => super.delete<TResult>(path, params, init),
      init && init.metric
    )
  }
